  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        const from = location.state?.from || (result.user.role === 'admin' ? '/admin/dashboard' : '/chat');
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Sign in to your College Chatbot account
            </p>
          </div>
          ...
          <div className="text-center">
            <p className="text-xs text-gray-500">
              Supports {getCurrentLanguageInfo()?.name || 'Multiple Languages'} • 
              Available 24/7 • Secure & Private
            </p>
          </div>
        </div>
      </div>
